...
func _ready():
	...
	total_time_label.add_theme_font_size_override("font_size", 28)
	...
	total_collectibles_label.add_theme_font_size_override("font_size", 28)
...
func show_game_complete_screen():
	...
	for level_data in stats["levels"]:
		...
		collectibles_label.add_theme_font_size_override("font_size", 20)
		collectibles_label.add_theme_color_override("font_color", Color(1.0, 0.8, 0.0, 1.0))  # Golden
		collectibles_label.custom_minimum_size.x = 140
